package dev.turtywurty.tutorialmod.client.animations;
...
public final class ExampleEntityAnimations {
    private ExampleEntityAnimations() {
        throw new UnsupportedOperationException("Illegal construction of constant-only class");
    }
    ...
    public static final AnimationDefinition SIT = AnimationDefinition.Builder.withLength(1.0F)
            ...
            .addAnimation("leg0", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(0.001F, -0.75F, 1.0F), AnimationChannel.Interpolations.LINEAR)
            ))
    ...
    public static final AnimationDefinition TAME = AnimationDefinition.Builder.withLength(1.5F)
            ...
            .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(1.25F, KeyframeAnimations.posVec(-6.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("leg0", new AnimationChannel(AnimationChannel.Targets.SCALE,
                    ...
                    new Keyframe(1.25F, KeyframeAnimations.scaleVec(1.0F, 1.5F, 1.0F), AnimationChannel.Interpolations.LINEAR),
